...
namespace EmploymentTest
{
    public class Employment_Should
    {
        ...
        public void Create_New_Default_Instance()
        {
            ...
            actual.Year.Should().Be(expectedYears);
        }
        ...
        public void Change_the_Title()
        {
            ...
            //Then - Assert check
            Assert.Equal(expectedTitle, sut.Title); // traditional way
            sut.Title.Should().Be(expectedTitle); // fluent assertion
