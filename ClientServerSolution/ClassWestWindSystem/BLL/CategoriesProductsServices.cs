...
{
    internal class CategoriesProductsServices
    {
        ...
        internal CategoriesProductsServices(WestWindContext registeredcontext)
        {
        ...
        // any methods to define the functionality of your service
